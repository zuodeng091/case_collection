...
<div class="page-content-area">
    <form id="form-user" class="form-signin" method="post">
        ...
        <div class="singleContent">
            ...
            <div class="right">
                <select id="cusLevel" name="cusLevel" disabled onchange="changeCus()" style="width: 155px" isNull="false" checkType="empty">
                    <option value="">请选择</option>
        ...
        <div class="singleContent">
            ...
            <div class="right">
                <select id="hasApprove" name="hasApprove" disabled style="width: 155px" isNull="false" checkType="empty">
                    <option value="">请选择</option>
